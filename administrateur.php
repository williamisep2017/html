...
/////////////////////////////////////////////////////////////////-->      
        ...
        <div class="wrap-profil">
                    <div id="header-bottom-profil">
                            <ul id="secondmenu" class="list-tabs">
                                <li><a class="a-hover" href="administrateur.php">Annonces</a></li>
                                <li><a class="a-hover" href="adm_user.php">Utilisateurs</a></li>
        ...
        foreach ($res as $an) {?>
                ...
                <td class="td"><p> <?php echo $an['choix_vente']; ?></p></td>
                 <td class="td"><p> <a href="del_an_adm.php?id_annonce=<?php echo $an['id_annonce'];?>"> Supprimer</a></p></td>
                </tr>
                 <?php } ?>
            </tbody>
        </table>
